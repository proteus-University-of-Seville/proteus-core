...
<!-- Content : PROTEUS default XSLT for conceptual modeling archetypes                  -->
...
>
  ...
  <!--
  <xsl:template
    match="object[contains(concat(' ', normalize-space(@classes), ' '),' system-operation ')]"
    name="system_operation_template"
    priority="1"
  >
